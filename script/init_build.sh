...
[ -f feeds.conf.default.rej ] && [ $type = "nss"] && echo "src-git nss_packages https://github.com/qosmio/nss-packages.git;NSS-12.5-K6.x" >> feeds.conf.default &&  echo "src-git sqm_scripts_nss https://github.com/qosmio/sqm-scripts-nss.git" >> feeds.conf.default && cat feeds.conf.default
